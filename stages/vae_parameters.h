...
#include "pipeline/kernel_library.h"
...
// Formats the virtual key for a 3x3 convolution weight packed as OCxKYxKXxIC
// for direct RHS fragment loads.
iree_status_t id4_vae_parameter_format_rhs_packed_conv3x3_weight_key(
    iree_string_view_t source_key, char* buffer,
    iree_host_size_t buffer_capacity, iree_string_view_t* out_key);

// Parses an RHS-packed 3x3 convolution virtual key and returns the source key.
...
// Parses a parity-packed upsample 3x3 virtual key and returns the source key.
