...
code to a dynamic Loom and HRX HAL implementation. It is intentionally about
...
```bash
bazel run //build_tools:trace_inventory -- \
  --trace-dir=<raw-trace> \
  --output=<inventory.json> \
  --hash-payloads

bazel run //build_tools:generate_fixture -- \
  --fixture-id=<fixture-id> \
  --trace-root=<raw-trace-root> \
  --fixture-root=<fixture-root>

bazel run //tooling:fixture_compare -- \
  --fixture-dir=<fixture> \
