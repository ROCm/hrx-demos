# Ideogram 4 FP8 Inference with Loom and the HRX HAL

This case study records a complete Ideogram 4 inference implementation authored
as Loom kernels and a standalone C program over the HRX HAL. The purpose was
...
physical GPU. ID4 used the HRX AMDGPU HAL with a ROCm 7.14 development runtime;
...
1. The HRX tokenizer is compared against the reference token sequence.
